...
color("tomato") {
    difference() {
        ...
        #translate([8,-90,8])cylinder(h=26, d=18);
        #translate([-8,-80,8])cylinder(h=26, d=18);
        #translate([8,-70,8])cylinder(h=26, d=18);
        #translate([-7,-55,8])cylinder(h=26, d=18.7);
        #translate([7,-40,8])cylinder(h=26, d=20.2);
        #translate([-7,-21,8])cylinder(h=26, d=22.6);
        #translate([6,-0.25,8])cylinder(h=26, d=24.7);
        #translate([-5,25,8])cylinder(h=26, d=26.7);
        #translate([3,54,8])cylinder(h=26, d=28.7);
        #translate([-2,85,8])cylinder(h=26, d=30.7);
    }
}
